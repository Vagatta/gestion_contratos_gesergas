...
CREATE TABLE IF NOT EXISTS clients (
    ...
    client_type   ENUM('particular','empresa') NOT NULL DEFAULT 'particular',
    tax_id        VARCHAR(20) DEFAULT NULL,
    birth_date    DATE DEFAULT NULL,
    fiscal_address   VARCHAR(300) DEFAULT NULL,
    comms_address    VARCHAR(300) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS contracts (
    ...
    energy_type        ENUM('gas','electricidad') DEFAULT NULL,
    tariff_type        VARCHAR(20) DEFAULT NULL,
    company            VARCHAR(200) DEFAULT NULL,
    cups               VARCHAR(100) DEFAULT NULL,
    annual_consumption VARCHAR(50)  DEFAULT NULL,
    power_p1           VARCHAR(50)  DEFAULT NULL,
    power_p2           VARCHAR(50)  DEFAULT NULL,
    product            VARCHAR(200) DEFAULT NULL,
    sale_date          DATE DEFAULT NULL,
    activation_date    DATE DEFAULT NULL,
    start_date         DATE DEFAULT NULL,
    end_date           DATE DEFAULT NULL,
    invoice_paper      TINYINT(1) NOT NULL DEFAULT 0,
    contract_paper     TINYINT(1) NOT NULL DEFAULT 0,
